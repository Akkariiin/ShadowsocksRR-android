...
#define CONFDIR "/data/data/moe.yuruyuri.akkariiin.shadowsocksrr"

#define CACHEDIR "/data/data/moe.yuruyuri.akkariiin.shadowsocksrr"

#define TEMPDIR "/data/data/moe.yuruyuri.akkariiin.shadowsocksrr/cache";
