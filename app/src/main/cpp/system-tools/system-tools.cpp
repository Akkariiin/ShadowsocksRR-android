...
jstring Java_moe_yuruyuri_akkariiin_shadowsocksrr_SystemTools_getabi(JNIEnv *env, jobject thiz) {
...
jint Java_moe_yuruyuri_akkariiin_shadowsocksrr_SystemTools_exec(JNIEnv *env, jobject thiz, jstring cmd) {
...
void Java_moe_yuruyuri_akkariiin_shadowsocksrr_SystemTools_jniclose(JNIEnv *env, jobject thiz, jint fd) {
    close(fd);
}

jint Java_moe_yuruyuri_akkariiin_shadowsocksrr_SystemTools_sendfd(JNIEnv *env, jobject thiz, jint tun_fd, jstring path) {
    int fd;
